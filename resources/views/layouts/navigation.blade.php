<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 md:hidden">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-lg font-bold text-primary">Tracking Konten</a>
                </div>
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <x-nav-link :href="route('postingan.export.aggregate')" :active="request()->routeIs('postingan.export.aggregate')">
                        {{ __('Laporan & Export') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('postingan.export.aggregate')" :active="request()->routeIs('postingan.export.aggregate')">
                {{ __('Laporan & Export') }}
            </x-responsive-nav-link>
        </div>
